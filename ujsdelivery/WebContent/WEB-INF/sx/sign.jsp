...
<!-- exp1="亚马逊" exp2="京东" exp3="赛澳递" exp4="南京晟邦" exp5="快捷快递" exp6="优速快递" exp7="国通" exp8="全峰快递" -->
			...
			<div class="form-group">
				...
				<select name="send_time" class="form-control">
					<option selected="selected">当天中午13:00—14:00</option>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<p style="font-size: 14px; margin: 10px 3px">①：校内：代取快递 2kg以下1元；超重件2—10元不等，特大件如沙发自行车等另算。<br/>
            ②：校外：教职工家属楼 代取快递 2kg以下2元；超重件3—15元不等，特大件如沙发自行车等另算。
</p>
					<div align="center">
