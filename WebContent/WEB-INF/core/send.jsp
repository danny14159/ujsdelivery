...
<body>
	...
	<div class="container well">
		<form id="fmain">
			<p class="board">下单后，${initParam.project_name }工作人员将会与您联系，并上门收件。中午寄件当天可发，晚上寄件次日可发。寄件时千万要记得准备好身份证哦。</p>
			...
			<div class="modal-content">
				...
				<div id="stdcontent">选择快递公司查看</div>
						<!-- <table class="table table-bordered table-striped">
							...
							<tr>
								<td class="text-primary">广东 福建 山东 江西 北京 湖南 天津 湖北</td>
								<td>15</td>
								<td>12</td>
								<td>2-3天</td>
								<td>汽运件 航空件</td>
							...
							<tr>
								<td class="text-primary">河南 云南 河北 贵州 重庆 海南 辽宁 吉林四川 山西 陕西 广西 黑龙江</td>
								<td>15</td>
								<td>15</td>
								<td>3-4天</td>
								<td>航空件</td>
							...
							<tr>
								<td class="text-primary">青海 甘肃 内蒙古 宁夏</td>
								<td>20</td>
								<td>20</td>
								<td>3-4天</td>
								<td>航空件</td>
							...
							<tr>
								<td class="text-primary">二级</td>
								<td>北京、天津、重庆、广东、山东、福建、湖北、湖南、河北、河南、江西、四川、山西</td>
								<td>12</td>
								<td>福建（包括）之前的8,江西（包括）之前的10,剩下的12</td>
							</tr>
							<tr>
								<td class="text-primary">三级</td>
								<td>辽宁、吉林、陕西、黑龙江、广西、云南、海南、贵州</td>
								<td>15</td>
								<td>12</td>
							</tr>
							<tr>
								<td class="text-primary">四级</td>
								<td>内蒙古、宁夏</td>
								<td>20</td>
								<td>16</td>
							</tr>
							<tr>
								<td class="text-primary">五级</td>
								<td>新疆、甘肃、青海</td>
								<td>22</td>
								<td>16</td>
							</tr>
...
function order(){
	...
	var $fm = $('#fmain'),
	 ...
	 $.post('/usend/ins',sdata,function(data){
		if(data===1){
			alert('恭喜你提交成功，到我的订单查看');location.href="/app/myback#anchor_send";
		}
		else if(data===-1){
			$('#mdlogin').modal();
